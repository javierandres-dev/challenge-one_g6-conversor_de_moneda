...
public class ExchangeRate {
    static void converter(byte option, double amount) throws IOException, InterruptedException {
        String baseCode = "";
        String targetCode = "";
        ...
        final String endpoint = "https://v6.exchangerate-api.com/v6/API-KEY/pair/" + baseCode + "/" + targetCode + "/" + amount;
